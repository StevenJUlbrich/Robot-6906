...
public class Auto_MoveFwd_1meter extends CommandBase {
  private DriveTrain m_drvTrain;
  /**
   * Creates a new Auto_MoveFwd_1meter.
   */
  public Auto_MoveFwd_1meter(DriveTrain drvTrain) {
    m_drvTrain = drvTrain;
  ...
  public Command getAutoCommand() {
    ...
    return ramseteCommand.andThen(() -> m_drvTrain.tankDriveVolts(0, 0));
  }
}